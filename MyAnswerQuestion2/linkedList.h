...
public:
    ...
    //Function that finds and deletes the smallest info from the list.
    ...
    Type FindHighest();
    //Function that returns the highest value from the list

    int FrequencyChecker(Type element);
    //Function to check the frequency of a character
    //Traverses the list and checks the frequency
    //Returns the number of times it existed on the list
...
template <class Type>
Type linkedListType<Type>::ComputeTotal()
{
